...
#funkce provadejici trideni pomoci algoritmu bubble sort
def bubble_sort(pole):
    print("BUBBLE SORT: Zatim nic nedelam")
    # TADY UPRAVIT (implementujte bubble sort. Delka pole je v konstante VELIKOST.)

        
#zavolani funkce na pripravene pole
bubble_sort(moje_pole)
