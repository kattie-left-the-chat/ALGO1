...
#funkce provadejici trideni pomoci algoritmu quick sort
def quick_sort(pole, p, r):
    print("QUICK SORT: Zatim nic nedelam")
    # TADY UPRAVIT (implementujte quick sort. Delka pole je v konstante VELIKOST.)

        
#zavolani funkce na pripravene pole
quick_sort(moje_pole, p, r)
